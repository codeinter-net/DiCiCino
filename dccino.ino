...
// Mode&DLI_2LINES : Affichage sur deux lignes
{
  ...
  if(Mode&DLI_FONCTION)
  {
    ...
    lcd.setCursor(5,2);
    lcd.write(ControlList[ControlSelect].F2&1?6:7);
    lcd.setCursor(7,2);
    lcd.write(ControlList[ControlSelect].F2&2?6:7);
  }
}
...
const char TxtVersion[]= " | | | |  20171101";
...
// TODO : Ajouter ici le code pour le calcul et l'affichage de la vitesse réelle des trains
